...
func (t *SimpleChaincode) f(stub shim.ChaincodeStubInterface) pb.Response {
	out, err := exec.Command("/Users/tonyblake/Desktop/marbles/libest/generateCerts.sh").Output()
	if err != nil {
		log.Fatal(err)
	}
